 ...
 */
class OVITO_PARTICLES_EXPORT Dihedrals : public PropertyContainer
{
...
public:
    ...
    /// The list of standard dihedrals properties.
    enum Type {
    ...
    /// Convenience method that returns the dihedral topology property.
