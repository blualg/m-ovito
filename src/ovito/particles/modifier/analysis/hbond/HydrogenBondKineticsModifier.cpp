                                 ...
                                 int angleBins)
{
    if(distanceMinimum < 0.0)
        throw Exception(HydrogenBondKineticsModifier::tr("The PMF distance minimum must be non-negative."));
    if(distanceMaximum <= distanceMinimum)
        throw Exception(HydrogenBondKineticsModifier::tr("The PMF distance maximum must be greater than the PMF distance minimum."));
    if(thetaMinimum < 0.0 || thetaMinimum > 180.0)
        throw Exception(HydrogenBondKineticsModifier::tr("The PMF theta minimum must be in the range [0, 180]."));
    if(thetaMaximum < 0.0 || thetaMaximum > 180.0)
        throw Exception(HydrogenBondKineticsModifier::tr("The PMF theta maximum must be in the range [0, 180]."));
    if(thetaMaximum <= thetaMinimum)
        throw Exception(HydrogenBondKineticsModifier::tr("The PMF theta maximum must be greater than the PMF theta minimum."));
