...
class OVITO_PARTICLES_EXPORT HydrogenBondKineticsModifier : public Modifier
{
    ...
    OVITO_CLASS_META(HydrogenBondKineticsModifier, OOMetaClass)
...
private:
    ...
    Future<PipelineFlowState> computeHydrogenBondKinetics(const ModifierEvaluationRequest& request, PipelineFlowState&& state);
    ...
    DECLARE_MODIFIABLE_PROPERTY_FIELD_FLAGS(DefinitionMode{PMFDerived}, definitionMode, setDefinitionMode, PROPERTY_FIELD_MEMORIZE);
    DECLARE_MODIFIABLE_PROPERTY_FIELD_FLAGS(FloatType{3.5}, donorAcceptorCutoff, setDonorAcceptorCutoff, PROPERTY_FIELD_MEMORIZE);
    DECLARE_MODIFIABLE_PROPERTY_FIELD_FLAGS(FloatType{30}, angleCutoff, setAngleCutoff, PROPERTY_FIELD_MEMORIZE);
    DECLARE_MODIFIABLE_PROPERTY_FIELD_FLAGS(FloatType{4.0}, vicinityCutoff, setVicinityCutoff, PROPERTY_FIELD_MEMORIZE);
...
{
    OVITO_CLASS(HydrogenBondKineticsModificationNode)
