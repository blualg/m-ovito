...
class OVITO_PARTICLES_EXPORT CoordinationEnvironmentAutocorrelationModifier : public Modifier
{
    ...
    OVITO_CLASS_META(CoordinationEnvironmentAutocorrelationModifier, OOMetaClass)
...
private:
    ...
    Future<PipelineFlowState> computeCoordinationData(const ModifierEvaluationRequest& request, PipelineFlowState&& state);
...
class OVITO_PARTICLES_EXPORT CoordinationEnvironmentAutocorrelationModificationNode : public ModificationNode
{
    OVITO_CLASS(CoordinationEnvironmentAutocorrelationModificationNode)
