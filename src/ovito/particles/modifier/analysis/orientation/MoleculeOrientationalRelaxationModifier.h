...
class OVITO_PARTICLES_EXPORT MoleculeOrientationalRelaxationModifier : public Modifier
{
    ...
    OVITO_CLASS_META(MoleculeOrientationalRelaxationModifier, OOMetaClass)
...
public:
    ...
    static QString correlationTableId() { return QStringLiteral("molecule-orientational-relaxation"); }
...
private:
    ...
    DECLARE_MODIFIABLE_PROPERTY_FIELD_FLAGS(DescriptorMode{DipoleVector}, descriptorMode, setDescriptorMode, PROPERTY_FIELD_MEMORIZE);
    ...
    DECLARE_MODIFIABLE_PROPERTY_FIELD_FLAGS(SelectionMode{SelectedAtTimeOrigin}, selectionMode, setSelectionMode, PROPERTY_FIELD_MEMORIZE);
...
class OVITO_PARTICLES_EXPORT MoleculeOrientationalRelaxationModificationNode : public ModificationNode
{
    OVITO_CLASS(MoleculeOrientationalRelaxationModificationNode)
