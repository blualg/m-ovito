...
IMPLEMENT_CREATABLE_OVITO_CLASS(DCDImporter);
OVITO_CLASSINFO(DCDImporter, "DisplayName", "DCD");
...
{
    TaskProgress progress(this_task::ui());
    progress.setText(tr("Reading DCD file %1").arg(fileHandle().toString()));
