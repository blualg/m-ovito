...
public:
    ...
    bool prepare(FloatType cutoffRadius, ConstPropertyAccess<Point3> positions, const SimulationCellObject* simCell, ConstPropertyAccess<SelectionIntType> selectionProperty);
