...
void defineModifiersSubmodule(py::module m)
{
	...
	ovito_class<VoronoiAnalysisModifier, AsynchronousModifier>(m,
			...
			" * ``Voronoi Surface Area`` (:py:class:`~ovito.data.ParticleProperty`):\n"
			"   Stores the surface area of each particle's Voronoi cell.\n"
			" * ``Voronoi Local Density`` (:py:class:`~ovito.data.ParticleProperty`):\n"
			"   Stores the inverse Voronoi cell volume, ``1/V``.\n"
