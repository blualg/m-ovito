...
class MoleculeOrientationalRelaxationModifier;
class VariantComboBoxParameterUI;

class MoleculeOrientationalRelaxationModifierEditor : public PropertiesEditor
{
    OVITO_CLASS(MoleculeOrientationalRelaxationModifierEditor)
    Q_OBJECT
...
private:
    ...
    MoleculeOrientationalRelaxationModifier* modifier() const;

    QPointer<QWidget> _manualDirectionWidget;
