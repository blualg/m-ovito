...
private:
    ...
    QComboBox* _stronglyCorrelatedPairsLagSelectionModeCombo = nullptr;
    ...
    QWidget* _stronglyCorrelatedPairsLagSelectionModeLabel = nullptr;
    QWidget* _stronglyCorrelatedPairsLagSelectionModeField = nullptr;
