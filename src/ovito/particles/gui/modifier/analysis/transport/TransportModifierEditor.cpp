...
void TransportModifierEditor::createUI(const RolloutInsertionParameters& rolloutParams)
{
    ...
    VariantComboBoxParameterUI* strongPairLagSelectionModeUI =
        createParamUI<VariantComboBoxParameterUI>(PROPERTY_FIELD(TransportModifier::strongPairLagSelectionMode));
    _stronglyCorrelatedPairsLagSelectionModeCombo = strongPairLagSelectionModeUI->comboBox();
    _stronglyCorrelatedPairsLagSelectionModeCombo->addItem(tr("Manual"),
        QVariant::fromValue(static_cast<int>(TransportModifier::ManualLagSelection)));
    _stronglyCorrelatedPairsLagSelectionModeCombo->addItem(tr("Auto (log-spaced)"),
        QVariant::fromValue(static_cast<int>(TransportModifier::AutomaticLogLagSelection)));
    _stronglyCorrelatedPairsLagSelectionModeLabel = new QLabel(tr("Lag selection"), strongPairsBox);
    _stronglyCorrelatedPairsLagSelectionModeField = _stronglyCorrelatedPairsLagSelectionModeCombo;
    strongPairsLayout->addWidget(_stronglyCorrelatedPairsLagSelectionModeLabel, 5, 0);
    strongPairsLayout->addWidget(_stronglyCorrelatedPairsLagSelectionModeField, 5, 1);
    ...
    strongPairsLayout->addWidget(_stronglyCorrelatedPairsLagPointsLabel, 6, 0);
    strongPairsLayout->addWidget(_stronglyCorrelatedPairsLagPointsField, 6, 1);
    ...
    strongPairsLayout->addWidget(_stronglyCorrelatedPairsPointCountLabel, 7, 0);
    strongPairsLayout->addWidget(_stronglyCorrelatedPairsPointCountField, 7, 1);
    ...
    strongPairsLayout->addWidget(_stronglyCorrelatedPairsResampleCountLabel, 8, 0);
    strongPairsLayout->addWidget(_stronglyCorrelatedPairsResampleCountField, 8, 1);
    ...
    strongPairsLayout->addWidget(new QLabel(tr("Custom thresholds"), strongPairsBox), 9, 0);
    strongPairsLayout->addWidget(strongPairThresholdsUI->textBox(), 9, 1);
    ...
    if(_stronglyCorrelatedPairsLagSelectionModeCombo)
        connect(_stronglyCorrelatedPairsLagSelectionModeCombo, qOverload<int>(&QComboBox::currentIndexChanged), this, &TransportModifierEditor::updateControlStates);
...
void TransportModifierEditor::updateControlStates()
{
    ...
    const bool useAutomaticStrongPairLagSelection =
        _stronglyCorrelatedPairsLagSelectionModeCombo &&
        _stronglyCorrelatedPairsLagSelectionModeCombo->currentData().toInt() == static_cast<int>(TransportModifier::AutomaticLogLagSelection);
    ...
    if(_stronglyCorrelatedPairsLagSelectionModeLabel)
        _stronglyCorrelatedPairsLagSelectionModeLabel->setVisible(computeStronglyCorrelatedPairs && useDiscreteStrongPairLagPoints);
    if(_stronglyCorrelatedPairsLagSelectionModeField)
        _stronglyCorrelatedPairsLagSelectionModeField->setVisible(computeStronglyCorrelatedPairs && useDiscreteStrongPairLagPoints);
    if(_stronglyCorrelatedPairsLagPointsLabel)
        _stronglyCorrelatedPairsLagPointsLabel->setVisible(computeStronglyCorrelatedPairs && useDiscreteStrongPairLagPoints && !useAutomaticStrongPairLagSelection);
    if(_stronglyCorrelatedPairsLagPointsField)
        _stronglyCorrelatedPairsLagPointsField->setVisible(computeStronglyCorrelatedPairs && useDiscreteStrongPairLagPoints && !useAutomaticStrongPairLagSelection);
    if(_stronglyCorrelatedPairsPointCountLabel)
        _stronglyCorrelatedPairsPointCountLabel->setVisible(computeStronglyCorrelatedPairs && useDiscreteStrongPairLagPoints && useAutomaticStrongPairLagSelection);
    if(_stronglyCorrelatedPairsPointCountField)
        _stronglyCorrelatedPairsPointCountField->setVisible(computeStronglyCorrelatedPairs && useDiscreteStrongPairLagPoints && useAutomaticStrongPairLagSelection);
