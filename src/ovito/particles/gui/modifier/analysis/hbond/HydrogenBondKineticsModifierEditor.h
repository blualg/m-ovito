...
class HydrogenBondKineticsModifier;

class HydrogenBondKineticsModifierEditor : public PropertiesEditor
{
    OVITO_CLASS(HydrogenBondKineticsModifierEditor)
    Q_OBJECT
...
private:
    ...
    HydrogenBondKineticsModifier* modifier() const;
