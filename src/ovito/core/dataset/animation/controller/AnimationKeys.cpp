...
IMPLEMENT_ABSTRACT_OVITO_CLASS(FloatAnimationKey);
IMPLEMENT_ABSTRACT_OVITO_CLASS(IntegerAnimationKey);
IMPLEMENT_ABSTRACT_OVITO_CLASS(Vector3AnimationKey);
IMPLEMENT_ABSTRACT_OVITO_CLASS(PositionAnimationKey);
IMPLEMENT_ABSTRACT_OVITO_CLASS(RotationAnimationKey);
IMPLEMENT_ABSTRACT_OVITO_CLASS(ScalingAnimationKey);
