...
/**
 * \brief Generic base class for notification events generated by a RefTarget object.
 */
...
public:
    ...
    enum Type {
        ...
        /// This event is generated by a RefMaker when a new reference has been added to one of its vector reference fields.
        ReferenceAdded,

        /// This event is generated by a RefMaker when a reference has been removed from one of its vector reference fields.
        ReferenceRemoved,

        /// This event is sent by an object to query whether it is currently referenced (indirectly) by some other object.
        CheckIsReferencedBy,
        ...
        /// This event is generated by a Pipeline or by an PipelineNode if the structure of the
        /// upstream pipeline changes.
        PipelineChanged,

        /// This event is generated by a Pipeline or by a PipelineNode if a new interactive state
        /// has been generated and the interactive viewports should be refreshed.
        ...
        /// End-of-list value indicating the next available event type that can be used by sub-classes of RefTarget for custom notifications.
...
public:
    ...
    explicit ReferenceEvent(int type, RefTarget* sender) noexcept : _type(type), _sender(sender) {}
    ...
    bool shouldPropagate() const {
        return type() == ReferenceEvent::TargetChanged || type() == ReferenceEvent::InteractiveStateAvailable || type() == ReferenceEvent::RequestGoToAnimationTime;
    }
...
public:
    ...
    /// Constructor.
    PropertyFieldEvent(int type, RefTarget* sender, const PropertyFieldDescriptor* field) noexcept :
...
public:
    ...
    /// Constructor.
    TargetChangedEvent(RefTarget* sender, const PropertyFieldDescriptor* field, const TimeInterval& unchangedInterval = TimeInterval::empty()) noexcept :
...
public:
    ...
    /// Constructor.
    ReferenceFieldEvent(int type, RefTarget* sender, const PropertyFieldDescriptor* field, RefTarget* oldTarget, RefTarget* newTarget, int index = -1) noexcept :
...
public:
    ...
    /// Constructor.
    explicit CheckIsReferencedByEvent(RefTarget* sender, const RefMaker* dependent, bool onlyStrongReferences) noexcept :
        ReferenceEvent(ReferenceEvent::CheckIsReferencedBy, sender),
        _dependent(dependent),
        _onlyStrongReferences(onlyStrongReferences) {}
...
public:
    ...
    /// Constructor.
    RequestGoToAnimationTimeEvent(RefTarget* sender, const AnimationTime& time) noexcept :
