 ...
 * This source file has been further adapted for OVITO.
 */
...
int  zran_init(
  ...
  void         *f,            /* Open handle to the compressed file object  */
...
int zran_seek(
  ...
  zran_point   **point    /* Optional place to store
                             corresponding zran_point        */
);
...
int zran_export_index(
  zran_index    *index, /* The index                         */
  void          *f      /* Open handle to export file object */
);
...
int zran_import_index(
  zran_index    *index, /* The index                         */
  void          *f      /* Open handle to import file object */
);
#endif