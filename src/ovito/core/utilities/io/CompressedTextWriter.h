...
public:
	...
	/// \param errorContext The object which provides a context for error messages generated by this writer.
	/// \throw Exception if an I/O error has occurred.
	CompressedTextWriter(QFileDevice& output, QObject* errorContext = nullptr);
...
private:
	...
	/// The context object used when throwing exceptions.
	QObject* _errorContext;
