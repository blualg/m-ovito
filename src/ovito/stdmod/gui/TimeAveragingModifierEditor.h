...
/**
 * A properties editor for the TimeAveragingModifier class.
 */
class TimeAveragingModifierEditor : public PropertiesEditor
{
    OVITO_CLASS(TimeAveragingModifierEditor)
    Q_OBJECT
...
private Q_SLOTS:
    ...
    /// Updates the currently visible parameter page.
