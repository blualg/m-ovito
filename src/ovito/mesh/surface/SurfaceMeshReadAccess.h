...
public:
    ...
    Vector3 edgeVector(edge_index edge, const ConstBufferAccess<Point3>& vertexPositions) const {
    ...
    Vector3 computeFaceNormal(face_index face, const ConstBufferAccess<Point3>& vertexPositions) const;
