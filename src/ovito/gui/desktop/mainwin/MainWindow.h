...
public:
    ...
    bool openDataInspector(PipelineNode* createdByNode, const QStringView objectIdentifierHint = {}, const QVariant& modeHint = {});

    /// Opens the data inspector using an explicitly supplied pipeline output state.
    bool openDataInspectorForPipelineOutput(PipelineFlowState pipelineOutput, PipelineNode* createdByNode,
