 ...
 */
class OVITO_GUI_EXPORT SceneNodesListModel : public QAbstractListModel, public UserInterfaceComponent<MainWindowUI>
{
    Q_OBJECT
...
private:
    ...
    /// The actions that are displayed as list items in the combobox.
