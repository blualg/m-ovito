...
protected:
    ...
    std::pair<FloatType,FloatType> plotData(const DataTable* table, DataTablePlotWidget* plotWidget, FloatType offset, FloatType fac, ConstBufferAccess<FloatType> normalization);
