...
void OXDNAImporter::FrameLoader::loadFile()
{
    ...
    PropertyAccess<Point3> centerOfMassPositionsArray = particles()->createProperty(QStringLiteral("Center Of Mass"), PropertyObject::Float, 3, QStringList() << QStringLiteral("X") << QStringLiteral("Y") << QStringLiteral("Z"));
    PropertyAccess<Point3> basePositionsArray = particles()->createProperty(QStringLiteral("Base Position"), PropertyObject::Float, 3, QStringList() << QStringLiteral("X") << QStringLiteral("Y") << QStringLiteral("Z"));
