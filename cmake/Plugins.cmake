...
MACRO(OVITO_STANDARD_PLUGIN target_name)
    ...
    IF(${ARG_GUI_PLUGIN})
        IF(OVITO_BUILD_APP)
            ...
            ELSE()
                FIND_PACKAGE(Qt6 ${OVITO_MINIMUM_REQUIRED_QT_VERSION} COMPONENTS Qml Quick QuickControls2 QuickTemplates2 REQUIRED)
                TARGET_LINK_LIBRARIES(${target_name} PUBLIC Qt6::Qml Qt6::Quick Qt6::QuickControls2 Qt6::QuickTemplates2)
            ENDIF()
        ELSE()
