...
FUNCTION(OVITO_DEPLOY_QT_FRAMEWORK_FILES)
    ...
    IF(UNIX AND NOT APPLE AND OVITO_REDISTRIBUTABLE_PACKAGE)
        ...
        OVITO_INSTALL_SHARED_LIB("${QtBinaryPath}/../plugins/platforms/wayland-shell-integration/libqt-shell.so" DESTINATION "./plugins_qt/wayland-shell-integration" OPTIONAL)
        OVITO_INSTALL_SHARED_LIB("${QtBinaryPath}/../plugins/platforms/wayland-shell-integration/libwl-shell-plugin.so" DESTINATION "./plugins_qt/wayland-shell-integration" OPTIONAL)
        OVITO_INSTALL_SHARED_LIB("${QtBinaryPath}/../plugins/platforms/wayland-shell-integration/libxdg-shell.so" DESTINATION "./plugins_qt/wayland-shell-integration" OPTIONAL)
        OVITO_INSTALL_SHARED_LIB("${QtBinaryPath}/../plugins/platforms/wayland-shell-integration/libivi-shell.so" DESTINATION "./plugins_qt/wayland-shell-integration" OPTIONAL)
