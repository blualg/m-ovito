...
OVITO for Windows includes an unmodified copy of the Qt shared libraries (version 6.8.3, MSVC 2022 64-bit) distributed by the Qt Company.
...
OVITO for macOS includes an unmodified copy of the Qt shared libraries (version 6.8.3) distributed by the Qt Company.
