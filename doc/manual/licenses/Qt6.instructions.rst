...
OVITO for Windows is built against the original, unmodified binary DLLs of Qt 6.5.1 (MSVC 2019 64-bit) distributed by the Qt Company.

Linux
"""""

OVITO for Linux includes Qt libraries that have been built from the unmodified sources of Qt 6.5.1 distributed by the Qt Company.
