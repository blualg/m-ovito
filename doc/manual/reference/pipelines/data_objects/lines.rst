...
by sampling the current positions of the particles over time. Alternatively, users can create lines manually 
using the :py:attr:`lines.create() <ovito.data.DataCollection.lines>` method.

The visual appearance of lines in rendered images is controlled by the associated 
