...
- Fix :ref:`particles.modifiers.delete_selected_particles` modifier not working for mulitple :ref:`scene_objects.lines` or :ref:`scene_objects.vector` objects in a pipeline.
